...
Phaser.Plugin.PhaserIlluminated.prototype._createLamp = function(x, y, config){
    ...
    sprite.refresh = function(){
        ...
        if(this.lighting){
            ...
            //the +0.01 forces illuminated.js to resize the caching canvas, which
            //is shared between all lighting instances.
            this.lighting.compute(this.bmd.width+0.01, this.bmd.height);
    ...
    sprite.createLighting =  function(opaqueObjects){
        ...
        lighting.compute(this.bmd.width, this.bmd.height);
